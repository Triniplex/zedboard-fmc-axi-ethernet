...
set_false_path -from [get_cells {bd_1_eth_mac_0_core/speed*speed_is*100_reg}] -to [get_cells {enable_gen/txspeedis*100gen/data_sync_reg0}]
set_false_path -from [get_cells {bd_1_eth_mac_0_core/speed*speed_is*100_reg}] -to [get_cells {rxspeedis10100gen/data_sync_reg0}]
set_false_path -from [get_cells {bd_1_eth_mac_0_core/speed*speed_is*100_reg}] -to [get_cells -filter {IS_SEQUENTIAL} {rgmii_interface/*}]
set_false_path -from [get_cells {bd_1_eth_mac_0_core/speed*speed_is*100_reg}] -to [get_cells -filter {IS_SEQUENTIAL} {enable_gen/*}]
...
set_false_path -from [get_cells -hierarchical -filter {NAME =~ *bd_1_eth_mac_0_core/addr_filter_top/address_filter_inst/*/DP}] -to  [get_cells -hierarchical -filter {NAME =~ *bd_1_eth_mac_0_core/addr_filter_top/address_filter_inst/*addr*/bit_match*reg[*]}]
...
set_false_path -from [get_cells {bd_1_eth_mac_0_core/sync_tx_reset*/sync_rst1_reg}] -to [get_cells {*/data_sync_reg0}]
...
set_multicycle_path 10 -setup -from [get_cells {bd_1_eth_mac_0_core/*managen/mdio_enabled.miim_clk_int_reg}  ] -throu [get_ports mdc]
set_multicycle_path 9 -hold -from   [get_cells {bd_1_eth_mac_0_core/*managen/mdio_enabled.miim_clk_int_reg}  ] -throu [get_ports mdc]
set_multicycle_path 10 -setup -from [get_cells {bd_1_eth_mac_0_core/*managen/mdio_enabled.phy/enable_reg_reg}] -throu [get_ports mdc]
set_multicycle_path 9 -hold -from   [get_cells {bd_1_eth_mac_0_core/*managen/mdio_enabled.phy/enable_reg_reg}] -throu [get_ports mdc]
set_multicycle_path 10 -setup -from [get_cells {bd_1_eth_mac_0_core/*managen/mdio_enabled.phy/mdio*reg}      ] -throu [get_ports mdio]
set_multicycle_path 9 -hold -from   [get_cells {bd_1_eth_mac_0_core/*managen/mdio_enabled.phy/mdio*reg}      ] -throu [get_ports mdio]
