#ifndef NETIF_ETHFMC_AXIE_H
#define NETIF_ETHFMC_AXIE_H
...
#define axienet_fmc_axienet_read_reg(BaseAddress, RegOffset)	\
	(axienet_fmc_axienet_in32(((BaseAddress) + (RegOffset))))

#define axienet_fmc_axienet_write_reg(BaseAddress, RegOffset, Data) \
	axienet_fmc_axienet_out32(((BaseAddress) + (RegOffset)), (Data))
