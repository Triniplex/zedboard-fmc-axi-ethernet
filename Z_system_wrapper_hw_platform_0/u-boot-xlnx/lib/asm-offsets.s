...
@ -I /root/zynq_linux_axiethernet_driver/u-boot-xlnx/arch/arm/include
...
@ -D __KERNEL__ -D CONFIG_SYS_TEXT_BASE=0x4000000 -D CONFIG_ARM -D __ARM__
...
@ -mabi=aapcs-linux -mword-relocations -march=armv7-a -mfloat-abi=soft
@ -mno-unaligned-access -mfpu=neon -mtls-dialect=gnu
...
@ -fno-common -ffixed-r9 -fno-strict-aliasing -fverbose-asm
...
.LFE183:
	...
	.text
.Letext0:
	.file 2 "/root/zynq_linux_axiethernet_driver/u-boot-xlnx/arch/arm/include/asm/types.h"
...
.LASF57:
	.ascii	"/root/zynq_linux_axiethernet_driver/u-boot-xlnx\000"
.LASF30:
